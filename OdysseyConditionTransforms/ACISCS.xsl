...
<!--*************************************************************************************
 *  ACISCS - Criminal Summons Issued - Case Add To ACIS
...
<xsl:import href="https://raw.githubusercontent.com/RichardDimmitt/ACIS-Integration/main/OdysseyConditionTransforms/OdysseyNodeCheck.xsl"/>
  ...
  <xsl:template match="/Integration">
    <xsl:variable name="ProcessActionEvent" select="'CS'"/>
    ...
    <xsl:choose>
      ...
      <xsl:when test="/Integration/Case/CaseEvent[@Op='A']/EventType[contains('EWCCSWC EWCCS',@Word)]">
