...
<!-- *** MOABCALEAwareToAcisCaseAddDenied.xml                                   *** -->
<!-- *** MOWCAwareToAcisCaseAddDenied.xml                                       *** -->
<!-- *** MOGCAwareToAcisCaseAddDenied.xml                                       *** -->
<!-- *** MOAwareToAcisCaseAddDenied.xml                                         *** -->
<!-- ****************************************************************************** -->
  ...
  <xsl:import href="https://raw.githubusercontent.com/RichardDimmitt/ACIS-Integration/main/OdysseyEventTransforms/E00050Denied.xsl"/>
  ...
  <xsl:import href="https://raw.githubusercontent.com/RichardDimmitt/ACIS-Integration/main/OdysseyEventTransforms/E50040.xsl"/>
  ...
  <xsl:template match="Integration">
    <OdysseyACISMessage>
      ...
      <AddMessage>
        ...
        <xsl:call-template name="E00050Denied"/>
